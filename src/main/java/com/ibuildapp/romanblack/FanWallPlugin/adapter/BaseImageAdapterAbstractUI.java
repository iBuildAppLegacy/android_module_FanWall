...
public class BaseImageAdapterAbstractUI extends BaseAdapter implements BaseImageAdapterInterface {
    ...
    public void setOnLoadedListener(BaseImageAdapterAbstractUI.onLoadedListener onLoadedListener) {
        this.onLoadedListener = onLoadedListener;
    }

    public BaseImageAdapterAbstractUI(Context context, AbsListView uiView) {
        this.uiView = uiView;
                ...
                if (threadList.size() < THREAD_POOL_SIZE) {
                    ...
                    if (taskItem != null) {
                        if (!threadList.contains(taskItem.uid)) {
                            GetBitmapTask task = new GetBitmapTask(context, taskItem.uid, taskItem.name, taskItem.imageView, taskItem.resPath, taskItem.cachePath, taskItem.uri, taskItem.width, taskItem.height, taskItem.rounded);
