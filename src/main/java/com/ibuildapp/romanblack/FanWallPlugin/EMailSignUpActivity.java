...
public class EMailSignUpActivity extends AppBuilderModuleMain implements OnClickListener,
    ...
    private final String DEFAULT_FIRST_NAME_TEXT = "First name";
    private final String DEFAULT_LAST_NAME_TEXT = "Last name";
    private final String DEFAULT_EMAIL_TEXT = "Email";
    private final String DEFAULT_PASSWORD_TEXT = "Password";
    ...
    @Override
    public void create() {
        setContentView(R.layout.romanblack_fanwall_emailsignup);

        signUpimageView = (ImageView) findViewById(R.id.romanblack_fanwall_emailsignup_btn_sugnup);
        signUpimageView.setOnClickListener(this);

        firstNameEditText = (EditText) findViewById(R.id.romanblack_fanwall_emailsignup_fname);
        ...
        lastNameEditText = (EditText) findViewById(R.id.romanblack_fanwall_emailsignup_lname);
        ...
        emailEditText = (EditText) findViewById(R.id.romanblack_fanwall_emailsignup_email);
        emailEditText.addTextChangedListener(this);
        emailEditText.setOnFocusChangeListener(this);
        emailEditText.setText(DEFAULT_EMAIL_TEXT);
        emailEditText.setTextColor(Color.GRAY);

        passwordEditText = (EditText) findViewById(R.id.romanblack_fanwall_emailsignup_pwd);
        passwordEditText.addTextChangedListener(this);
        passwordEditText.setOnFocusChangeListener(this);
        passwordEditText.setText(DEFAULT_PASSWORD_TEXT);
        passwordEditText.setTextColor(Color.GRAY);

        rePasswordEditText = (EditText) findViewById(R.id.romanblack_fanwall_emailsignup_rpwd);
        ...
        termsCheckBox = (CheckBox) findViewById(R.id.romanblack_fanwall_emailsignup_chbterms);
        termsCheckBox.setOnClickListener(this);

        termsLayout = (LinearLayout) findViewById(R.id.romanblack_fanwall_emailsignup_layouttems);
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = ProgressDialog.show(this, null, "Registration...");
        } else {
    ...
    public void onClick(View arg0) {
        if (signUpimageView == arg0) {
            if (signUpActive) {
                ...
                if (firstNameEditText.getText().toString().equals(
                        lastNameEditText.getText().toString())) {
                    Toast.makeText(this, "First and Last name match each "
                            + "other. This seems like a spam, please change"
                            + " Last or First name.", Toast.LENGTH_LONG).show();
                    return;
                }

                if (firstNameEditText.getText().toString().length() <= 2
                        || lastNameEditText.getText().toString().length() <= 2) {
                    Toast.makeText(this, "Your name should have at least 2 characters.", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (passwordEditText.getText().toString().length() < 4) {
                    Toast.makeText(this, "Your password should have at least 2 characters.", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    public void onFocusChange(View arg0, boolean arg1) {
        if (arg0.getId() == R.id.romanblack_fanwall_emailsignup_fname) {
            if (arg1) {
        ...
        } else if (arg0.getId() == R.id.romanblack_fanwall_emailsignup_lname) {
            if (arg1) {
        ...
        } else if (arg0.getId() == R.id.romanblack_fanwall_emailsignup_email) {
            if (arg1) {
        ...
        } else if (arg0.getId() == R.id.romanblack_fanwall_emailsignup_rpwd) {
            if (arg1) {
                if (((TextView) arg0).getText().toString().equals(DEFAULT_PASSWORD_TEXT)) {
                    ((TextView) arg0).setText("");
                    ((TextView) arg0).setTextColor(Color.BLACK);
